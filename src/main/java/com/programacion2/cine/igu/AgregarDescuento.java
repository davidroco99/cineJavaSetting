...
public class AgregarDescuento extends javax.swing.JFrame {
    private static AgregarDescuento instance = null;
    ...
    public static AgregarDescuento getInstance() {
        if (instance == null) {
            instance = new AgregarDescuento();
        }
        return instance;
    }
    ...
    private void initComponents() {
        ...
        labelAddDescuento.setText("Add Descuento");
    ...
    private void btnAgregarDescuentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarDescuentoActionPerformed
        ...
        controla.agregarDescuento(dtoDescuento);
